...
class MentorfeedbackForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'lifestyle' : forms.Textarea(attrs={'style':'resize:none;', 'rows':4, 'placeholder':'학교- 학원-집 의 규칙적인 생활을 하며 성실하게 임하고 있습니다. 하지만 학원에 밤 12시까지 있으면서 ~~~입니다. 오랜 시간 앉아서 공부하는 것보다 하루하루의 목표량을 정하고 달성하면 쉴수 있는 보상을 주어 좀 더 효율적인 공부를 할 수 있을 것입니다 등'}),
